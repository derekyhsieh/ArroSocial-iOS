...
struct PostView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showPosterProfileView) {
            ProfileView(isUsersOwnProfile: .constant(false), profilePosts: PostsViewModel(userID: post.userID), profilePictureVM: ProfilePictureViewModel(userID: post.userID), selectedPost: $selectedPost, profileUser: post.username, postUserID: post.userID)
        }
